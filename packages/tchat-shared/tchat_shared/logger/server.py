"""Server-side logger — syslog-style formatting with optional file output."""
import os
...
def _prefix( level: str ) -> str:
    """Build a syslog-style prefix: `Mon DD HH:MM:SS tchat[PID]: LEVEL`."""
...
def message( msg: Message ) -> None:
    """Log a chat message based on its type."""
...
def _log_to_file( msg: str ) -> None:
    """Append msg to the configured log file if file logging is enabled."""
