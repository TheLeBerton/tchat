...
class TypingHandler:
    ...
    def handle( self, address: tuple[str, int], msg: TypingMessage, state: ServerState ) -> None:
    ...
    def _broadcast_user_is_typing( self, username: str, address: tuple[str, int], msg: TypingMessage, state: ServerState ) -> None:
